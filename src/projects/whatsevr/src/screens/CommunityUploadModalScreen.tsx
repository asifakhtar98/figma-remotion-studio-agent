      ...
      <div className="absolute bottom-0 inset-x-0 z-30 bg-white rounded-t-[36px] px-7 pt-4 pb-8 shadow-2xl flex flex-col gap-4 border-t border-gray-100">
        ...
        <div className="flex flex-col gap-3 mt-1">
          {uploadOptions.map((option) => (
            <div
              key={option.label}
              className="flex items-center gap-4 p-3.5 bg-gray-50 border border-gray-200/80 rounded-2xl cursor-pointer hover:bg-gray-100/80 transition-colors shadow-2xs"
            >

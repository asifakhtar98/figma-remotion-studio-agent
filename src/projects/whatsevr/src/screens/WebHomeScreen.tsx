  ...
  return (
    ...
    >
      ...
      <aside className="w-[240px] h-full bg-white border-r border-zinc-200/90 flex flex-col justify-between p-6 z-20 shrink-0">
        ...
        {/* Sidebar Footer: Wallet Balance & Logout */}
      ...
      <main className="relative flex-1 h-full bg-white flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col p-14 pl-16">
          {/* Header Greeting */}
          <div className="flex flex-col">
            <h1 className="text-2xl font-bold text-zinc-900 tracking-tight">
              Hi Rahul Sharma
            </h1>
            <p className="text-sm text-zinc-500 font-normal mt-1.5">
              What do you feel like today?
            </p>
          </div>

          {/* Feature Cards Row */}
          <div className="flex flex-row gap-5 mt-8 w-full max-w-[800px]">
            {/* Card 1: Random Match */}
            <div className="flex-1 flex flex-col justify-start p-6 rounded-2xl bg-white border border-zinc-200/90 shadow-2xs hover:border-zinc-300 transition-colors min-h-[128px]">
              <h2 className="text-base font-semibold text-zinc-900 tracking-tight">
                Random Match
              </h2>
              <p className="text-sm text-zinc-500 font-normal mt-1.5 leading-relaxed">
                Start — talk to someone new right now.
              </p>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-start p-6 rounded-2xl bg-white border border-zinc-200/90 shadow-2xs hover:border-zinc-300 transition-colors min-h-[128px]">
              ...
              <p className="text-sm text-zinc-500 font-normal mt-1.5 leading-relaxed">
                Browse who is live and start a One2One call.
              </p>
            </div>
          </div>
        </div>
